...
Create a Course class with private attributes courseName, capacity, and enrolledStudents. 
A method enrollStudent() that throws CourseFullException if the course is already full. Create a custom checked exception CourseFullException. 
Write a CourseCapacityDemo class to enroll students in a course, Handle the CourseFullException when the course is full.
*/
