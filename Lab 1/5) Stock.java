...
class Stock
{
  public static void main(String args[])
  {
   ...
   System.out.println("\nEnter respective product prices in separate lines");
   for(int i=0;i<n;i++) price[i]=sc.nextDouble();
   System.out.print("\nEnter the number of specific distinct items you want to buy>   int choice=sc.nextInt();
   String cart[]=new String[choice];
   double total[]=new double[choice];
   sc.nextLine();
   System.out.println("\nEnter the product names which you want to buy exactly as >   for(int i=0;i<choice;i++) cart[i]=sc.nextLine();
   ...
   System.out.println("\nEnter respective product quantities:");
